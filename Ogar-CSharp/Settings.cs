...
namespace Ogar_CSharp
{
    public class Settings
    {
        ...
        public HashSet<string> listenerAcceptedOrigins = new HashSet<string>();
        public HashSet<string> listenerForbiddenIPs = new HashSet<string>();
        ...
        public HashSet<string> chatFilteredPhrases = new HashSet<string>();
        ...
        public HashSet<string> worldPlayerBotNames = new HashSet<string>();
        public HashSet<string> worldPlayerBotSkins = new HashSet<string>();
